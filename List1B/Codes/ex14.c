...
int main()
{
  // Um vendedor necessita de um algoritmo que calcula o pre�o total devido por um cliente.
  // o algoritmo deve receber o c�digo do produto e a quantidade comprada.
  // Ap�s, calcular o pre�o total.
